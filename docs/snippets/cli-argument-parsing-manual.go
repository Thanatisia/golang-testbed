                ...
                case "--set-value":
                    ...
                    if i < argc-1 {
                        ...
                        if tmp_val != "" {
                            ...
                            error_msg = append(error_msg, fmt.Sprintf("Parameter [%s]: Value not provided.", curr_arg))
                        }
                    } else {
                        error_msg = append(error_msg, fmt.Sprintf("Parameter [%s]: Insufficient values provided.", curr_arg))
                    }
                default:
                    res_args_pos = append(res_args_pos, curr_arg)
            }
