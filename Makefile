...
GO_ENTRYPOINT ?= ./main.go # Define your entry point source file 'main.go' path here

### Project sources
#### Package/library/module Dependencies
PKG_DEPS ?= github.com/mattn/go-sqlite3 # Specify your package dependencies to download/install/'get' here; i.e GitHub: github.com/author/package-name; Separate each package/module/library repository server URL with a space delimiter (' ')
#### Output directories
OUT_DIR ?= dist/bin
#### Output binary files
OUT_BIN ?= testbench.exe
